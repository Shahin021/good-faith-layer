...
def test_scenario03_rc5_runtime():
    ...
    attested = Path(
        "scenarios/03_ambiguous/attested.json"
    ).read_text(encoding="utf-8")

    assertions = Path(
        "scenarios/03_ambiguous/assertions.json"
    ).read_text(encoding="utf-8")
    ...
    tx(
        ...
        [
            ...
            1000,
            "gfl-standard-v1",
            "Consulting retainer, month 1 of 3",
        ],
    )
